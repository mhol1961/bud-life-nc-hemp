Deno.serve(async (req) => {
    ...
    try {
        ...
        const orderNumber = `BL-${Date.now()}-${Math.random().toString(36).substr(2, 4).toUpperCase()}`;
        ...
        const orderData = {
            ...
            square_payment_id: paymentIntent.id, // Using existing field for stripe payment intent id
